...
This is a simple Angular 6 Template generated with the latest [Angular CLI](https://github.com/angular/angular-cli) version 7.0.2 ready to work with it.

The template use **SASS** and include **[Bootstrap 4](https://getbootstrap.com/docs/4.1/getting-started/introduction/)** and **[Normalize 8.0.0](https://necolas.github.io/normalize.css/)**.

All the packages included in **the package.json are always updated** to the latest and usable version.  
